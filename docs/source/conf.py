...
# -*- coding: utf-8 -*-
#
# ipyscore documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipyscore', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'ipyscore.tex', 'ipyscore Documentation',
     'David Brochart', 'manual'),
]
